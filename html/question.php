                                ...
                                switch ($questions_list->type) {
                                    case "radiobutton":
                                       ...
                                       ?>
                                        <fieldset>
                                            ...
                                            <div class="col-sm-3 input-group">
                                                <a name="addanswer" onclick="addanswer('<?php echo $questions_list->id; ?>', '<?php echo $questions_list->type; ?>')" class="btn btn-sm btn-success">Добавить</a>
                                            </div>
                                        </fieldset>
                                    ...
                                    case "checkbox":
                                        ...
                                        <fieldset>
                                            <hr/>
                                            <div class="col-sm-9">
                                                <input type="text" id="<?php echo $answer_object->id ?>answer_text_new" name="answer_text_new" placeholder="Введите текст ответа"
                                                                                                              class="form-control form-control-success"/>
                                            </div>
                                    ...
                                    case "order":
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" id="<?php echo $questions_list->id ?>answer_text2_new" name="answer_text2_new"
                                                       placeholder="Введите текст соответствия"
...
<hr/>
                                ...
                                <fieldset>
                                    <hr/>
                                    <div class="col-sm-10">
                                        <input type="text" id="<?php echo $questions_list->id ?>tip_text_new" name="tip_text_new" placeholder="Введите текст подсказки"
                                               class="form-control form-control-success"/>
                                    </div>

                                    <div class="col-sm-2 input-group">
                                        <a name="addtip" onclick="addtip('<?php echo $questions_list->id; ?>')" class="btn btn-sm btn-success">Добавить</a>
                                    </div>
                                </fieldset>
