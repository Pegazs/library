...
<html>
<head>
    <title>Редактирование вопросов к тесту — <?php echo mysqli_fetch_object(mysqli_query($con, "SELECT settings_value FROM settings WHERE settings_name ='site_name'"))->settings_value ?></title>
    ...
    <script type="text/javascript">
        ...
        function newquestion(t_id){
            ...
            $.ajax({
                type:"post",
                url:"question_operations/newquestion.php",
                "data": {
                    "id": t_id,
        ...
        function oldquestion_delete(id){
            $.ajax({
                type:"post",
                url:"question_operations/oldquestion_delete.php",
                "data": {
                    "question_id": id
                },
                success:function(data){
        ...
        function oldquestion(id){
            ...
            $.ajax({
                type:"post",
                url:"question_operations/oldquestion.php",
                "data": {
                    "question_id": id,
        ...
        function addanswer(id, type){
            ...
            $.ajax({
                type:"post",
                url:"question_operations/addanswer.php",
                "data": {
                    "question_id": id,
                    "question_type": type,
        ...
        function editanswer(q_id, q_type, a_id){
            ...
            $.ajax({
                type:"post",
                url:"question_operations/editanswer.php",
                "data": {
        ...
        function deleteanswer(q_id, a_id, a_number){
            $.ajax({
                type:"post",
                url:"question_operations/deleteanswer.php",
                "data": {
                    "question_id": q_id,
                    "answer_id": a_id,
            ...
            setTimeout(question(q_id), 255);
        }

        function correctanswer(q_id, q_type, a_id){
            $.ajax({
                type:"post",
                url:"question_operations/correctanswer.php",
                "data": {
                    "question_id": q_id,
                    "question_type": q_type,
                    "answer_id": a_id
        ...
        function addtip(id){
            ...
            $.ajax({
                type:"post",
                url:"question_operations/addtip.php",
                "data": {
                    "question_id": id,
        ...
        function edittip(q_id, t_id){
            ...
            $.ajax({
                type:"post",
                url:"question_operations/edittip.php",
                "data": {
                    "tip_id": t_id,
                    "tip_text": t_text.value
                }
        ...
        function deletetip(q_id, t_id, t_number){
            $.ajax({
                type:"post",
                url:"question_operations/deletetip.php",
                "data": {
                    "question_id": q_id,
                    "tip_id": t_id,
                    "tip_number": t_number
...
<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="settingsform" enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            <div class="col-md-10 well">
                ...
                <div class="form-group">
                    <span><?php if (isset($excel_success)) { echo $excel_success; } ?></span>
                    <span><?php if (isset($excel_error)) { echo $excel_error; } ?></span>
                    <div class="row">
                        <div class="col-md-3">
                            <input type="file" id="upload_file" name="upload_file" />
                        </div>
                        <div class="col-md-2">
                            <input type="submit" value="Импортировать" name='importexcel' class="btn btn-info btn-block">
                        </div>
                    </div>
                </div>
</form>
...
<table class="table table-bordered">
    <tr>
        <td>
            <form role="form" action="<?php echo $_SERVER['PHP_SELF'].'#place_newquestion'; ?>" method="post" name="newquestionform" enctype="multipart/form-data">
                <fieldset>
                    <input type="hidden" value="<?php echo $test_id ?>" name="id" readonly="readonly" required value="<?php if($error) echo $test_id; ?>" class="form-control" />
                    <div class="form-group">
                        <label for="question_text_new">Текст вопроса</label>
                        <textarea id="question_text_new" name="question_text_new" rows="1" placeholder="Введите текст вопроса" required class="form-control" ></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="comment_text_new" name="comment_text_new" rows="2" placeholder="Будет показываться на странице результатов" class="form-control" ></textarea>
