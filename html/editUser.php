...
<html>
<head>
	<title>Редактирование информации о пользователе — <?php echo mysqli_fetch_object(mysqli_query($con, "SELECT settings_value FROM settings WHERE settings_name ='site_name'"))->settings_value ?></title>
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="settingsform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="text" name="name" placeholder="Введите имя" required value="<?php echo $name; ?>" class="form-control" />
